                ...
                <div class="col-md-6 col-lg-9 col-xl-4 offset-xl-1">
                    <form action="{{ route('file.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="divider d-flex align-items-center my-4">
                            <p class="text-center fw-bold mx-3 mb-0 fs-h1">File Sharing Application</p>
                        </div>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" class="btn btn-primary"
                                    style="padding-left: 2.5rem; padding-right: 2.5rem; background-color: #094D86">Upload
                            </button>
                            <a href="{{route('home')}}" class="btn btn-secondary"
                               style="padding-left: 2.5rem; padding-right: 2.5rem; background-color: #F2AA1F">home
                            </a>
                        </div>
